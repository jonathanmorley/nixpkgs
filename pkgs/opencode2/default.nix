...
in
  ...
  stdenvNoCC.mkDerivation (_finalAttrs: rec {
    ...
    # TODO: bump the beta by updating `version` and the `hash`. The npm dist
    # tag is `@opencode-ai/cli@beta`; regenerate the hash with:
    #   nix-prefetch-url --type sha256 \
    #     "https://registry.npmjs.org/@opencode-ai/cli-darwin-arm64/-/cli-darwin-arm64-<version>.tgz"
    src = fetchurl {
