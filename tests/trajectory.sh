...
assert_contains "modules/ai/trajectory.nix" "opencode" "Trajectory module has opencode option"
assert_contains "modules/ai/home.nix" "trajectory.opencode.enable" "Home Manager makes OpenCode Trajectory wiring conditional on opencode.enable"
...
assert_contains "modules/ai/home.nix" 'mcp = lib.optionalAttrs' "Home Manager configures trajectory MCP server conditionally"
