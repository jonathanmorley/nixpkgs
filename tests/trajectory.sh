...
assert_contains "modules/ai/home.nix" "home.activation.trajectory-setup" "Home Manager registers CC/Codex plugins via activation"
assert_contains "modules/ai/home.nix" "trajectory setup --clients cc" "Activation registers Trajectory with Claude Code"
