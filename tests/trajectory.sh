...
assert_contains "modules/ai/home.nix" 'home.file.".trajectory"' "Home Manager symlinks the .trajectory directory from the package"
assert_home_file_forced ".trajectory" "Home Manager force-owns the .trajectory symlink"
# shellcheck disable=SC2016
assert_contains "modules/ai/home.nix" '${pkgs.trajectory}/.trajectory' "Home Manager .trajectory symlink targets the package output"
# shellcheck disable=SC2016
