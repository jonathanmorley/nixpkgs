...
in {
  nixpkgs.overlays = lib.optional hasOpenCode opencodeDesktopOverlay;
  ...
  environment.systemPackages =
    ...
    ++ lib.optional (hasOpenCode && pkgs.stdenv.hostPlatform.isAarch64) pkgs.opencode-desktop;
  ...
  homebrew = {
    ...
    casks =
      ...
      ++ lib.optional (!hasOpenCode || !pkgs.stdenv.hostPlatform.isAarch64) "opencode-desktop";
  };
}
